...
| 自然文 + LoRA rank=8 (202605061327) | 0.7212 | mostly echo | |
| **No LoRA + Instruction Diverse (202605061813)** | **0.7345** | **全件自然文・指示汎化成功** | 全実験最高 F1・B-0 目標達成 |
| rank=8 + Instruction Diverse (202605061807) | 0.5604 | 全件崩壊 | LoRA+多様化は小データで過負荷 |
